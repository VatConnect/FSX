// GUI-FSW.cpp : Defines the exported functions for the DLL application.
//
...
//DirectX 11 hooking functions and data
unsigned char OrigCode11[5];          //Original code at start of D3D's Present function 
unsigned char PatchCode11[5];         //The patched code we overlay 
unsigned char* pPatchAddr11 = NULL;   //Address of the patch (start of the real Present function)
void HookIntoD3D11();
void ApplyPatch11();
void RemovePatch11();
typedef HRESULT(_stdcall *RealPresent11FuncType)(void*, const RECT*, const RECT*, HWND, const RGNDATA*);
RealPresent11FuncType RealPresent11;
